...
- Until concrete product architecture exists, the versioned Harness Engineering scaffold is the repository's delivery workflow and source of process truth.
...
- Treat router output as recommended starting context; inspect any additional repository files needed for the current request.
